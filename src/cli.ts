...
export function buildCli(): CLI {
  return createCLI({
    ...
    commands: {
      ...
      "red-router": {
        description: "report or manage the RedRouter service every coding agent points at",
        positional: [
          {
            name: "router_verb",
            description: "status, install, or uninstall",
            required: false,
          },
        ],
      },
      "red-skills": {
        ...
        description:
          "acquire the RedSkills package set: list-all, latest-stable, install [selector], sync <path>, reconcile, adopt, watch",
        positional: [
          {
            name: "phase",
            description: "list-all, latest-stable, install, sync, reconcile, adopt, watch",
            required: false,
          },
          {
            name: "selector",
